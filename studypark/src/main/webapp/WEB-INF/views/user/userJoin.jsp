...
.joinButton button{font-size:16px;color:white;padding: 10px 50px;background: #1CD8A9;border: 1px solid #1CD8A9; border-radius: 5px;}
</style>
...
<form>
	...
	<div class="agreeMainBox">
		...
		<div class="agreeBox">
			<ul>
				<li><input type="checkBox"/><p>전체동의</p></li>
				<li class="agreeLine"></li>
				<li><input type="checkBox"/><p>만 14세 이상입니다.</p><p class="pil">(필수)</p></li>
				<li><input type="checkBox"/><p>이용약관</p><p class="pil">(필수)</p></li>
				<li><input type="checkBox"/><p>개인정보취급방침</p><p class="pil">(필수)</p></li>
				<li><input type="checkBox"/><p>이벤트, 프로모션 알림 메일 및 SNS수신</p><p class="pil">(필수)</p></li>
			</ul>
		</div>
